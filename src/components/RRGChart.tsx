...
export default function RRGChart({ data }: { data: any[] }) {
  ...
  return (
    // Fixed height to h-[600px] to ensure visibility
    <div className="w-full h-150 rounded-xl border border-slate-800 bg-[#0B1121] overflow-hidden shadow-xl">
      <ResponsiveContainer width="100%" height="100%">
        <ScatterChart margin={{ top: 20, right: 30, bottom: 20, left: 20 }}>
          ...
          <XAxis type="number" dataKey="x" domain={domain} ticks={ticks} stroke="#94a3b8" tick={{ fill: '#94a3b8', fontSize: 11 }} interval={0}>
             <Label value="Relative Trend (RS-Ratio)" offset={-10} position="insideBottom" fill="#94a3b8" fontSize={12} />
          </XAxis>
          <YAxis type="number" dataKey="y" domain={domain} ticks={ticks} stroke="#94a3b8" tick={{ fill: '#94a3b8', fontSize: 11 }} interval={0}>
